           	...
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img src="img/kithmi.jpg" alt="">
							</div>
							<div class="media-body">
								<div class="personal_text">
									<h6>Hello Everybody, i am</h6>
									<h3>Kithmi Ranaweera</h3>
									<h4>Software Developer</h4>							</h5>
										I am an enthusiastic, hard working,honest individual. Also good timekeeper and always willing to learn new things.love to be helpful and polite with others.							</h5>
									</p>
									<ul class="list basic_info">
										<li><a href="#"><i class="lnr lnr-calendar-full"></i> 24th July, 1995</a></li>
										<li><a href="#"><i class="lnr lnr-envelope"></i> kithmiranaweera@gmail.com</a></li>
										<li><a href="#"><i class="lnr lnr-home"></i> Matara, Sri Lanka</a></li>
									</ul>
        		...
        		<div class="row welcome_inner">
        			<div class="col-lg-6">
        				<div class="welcome_text">
        					<h4>About Myself</h4>
							<div class="col-md-6 mt-sm-40">
									<h3 class="mb-20">Interested In</h3>
									<div class="">
        			...
        			<div class="col-lg-6">
							<h3 class="mb-20">My Technical Skills</h3>
											<div class="">
												<ul class="unordered-list">
														<li>php</li>
														<li>Laravel</li>
							...
							<ul class="list">
								<li>
										...
										<div class="media">
											...
											<div class="media-body">
												...
												<p>Bachelor of Science in  <br />Information System(Reading).</p>
											</div>
										</div>
								</li>
								<li>
									...
									<div class="media">
										...
										<div class="media-body">
											<h4>Sujatha Balika Vidyalaya, Matara</h4>
											<p>Passed Advanced Level in <br /> Physical Science Stream..</p>
										</div>
									</div>
								</li>
								<li>
								...
								<span></span>
									<div class="media">
										...
										<div class="media-body">
											<h4>ST' Mary's Convent, Matara</h4>
											<p>Passed Ordinary Level <br />Examination.</p>
										</div>
									</div>
        ...
        <section class="feature_area p_120">
        	<div class="container">
        		<div class="main_title">
        			...
        			<p>I used HTML, CSS, Bootstrap, MDBootsrap, PHP, Laravel, Nodejs, JQuery, Javasript, MYSQL, MongoDB For this projects </p>
        		</div>
